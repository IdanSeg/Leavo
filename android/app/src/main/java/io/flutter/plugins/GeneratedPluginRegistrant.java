...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.aramillo.app_to_foreground.AppToForegroundPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin app_to_foreground, com.aramillo.app_to_foreground.AppToForegroundPlugin", e);
    }
    try {
